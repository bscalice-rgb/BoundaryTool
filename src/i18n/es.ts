...
export const es: Dictionary = {
  ...
  'flag.nonAscii.title': '{field} — caracteres que CropForce no acepta',
  'flag.nonAscii.detail.one': '{columns} contiene {characters}. CropForce acepta solo letras y números simples. La corrección automática lo escribe como «{example}».',
  'flag.nonAscii.detail.other': '{columns} contienen {characters}. CropForce acepta solo letras y números simples. La corrección automática escribe el primero como «{example}».',
  'guidance.non-ascii': 'Los caracteres acentuados y no latinos no sobreviven a la carga: CropForce acepta letras, números y puntuación simple. Améca tiene que llegar como Ameca y Caiçara como Caicara. Los nombres leídos de un archivo se convierten al entrar; este control atrapa los que se escriben después. Dos nombres que solo se diferenciaban por el acento pasan a ser el mismo, así que la corrección los numera aparte si eso ocurre.',
  'category.non-ascii': 'Acentos',
  'fix.asciified.one': 'Se reescribió 1 nombre sin acentos.',
  'fix.asciified.other': 'Se reescribieron {count} nombres sin acentos.',
  'fix.alreadyPlain': 'Todos los nombres ya están sin acentos.',
  'tree.open': 'Vista general Client / Farm / Field',
  'tree.title': 'Client / Farm / Field',
  'tree.intro': 'Todo lo de esta sesión, en el orden en que CropForce lo organiza. Elija cualquier fila para trabajar en ella.',
  'tree.empty': 'Todavía no hay nada cargado.',
  'tree.noClient': '(sin cliente)',
  'tree.noFarm': '(sin finca)',
  'tree.noField': '(lote sin nombre)',
  'tree.counts.one': '1 lote',
  'tree.counts.other': '{count} lotes',
  'tree.farms.one': '1 finca',
  'tree.farms.other': '{count} fincas',
  'tree.ungrouped.one': '1 polígono fuera de todo lote',
  'tree.ungrouped.other': '{count} polígonos fuera de todo lote',
  'tree.blocking': '{count} bloqueantes',
  'tree.expandAll': 'Expandir todo',
  'tree.collapseAll': 'Contraer todo',
  'tree.copy': 'Copiar como texto',
  'tree.copied': 'Vista general copiada al portapapeles.',

  'import.chooseFiles': '¿Qué archivos?',
  'import.chooseHelp': 'Destilde lo que no quiera. Los archivos cuyo nombre ya está en el espacio de trabajo vienen destildados, porque cargar el mismo dos veces es la forma habitual de duplicar un contorno.',
  'import.alreadyLoaded': 'ya cargado',
  'import.selectFile': 'Incluir {file}',
  'import.selectAllFiles': 'Incluir todos los archivos',
  'import.noneChosen': 'Ningún archivo tildado.',
  'import.preview': 'Qué hay en los archivos',
  'import.previewHelp': 'Las primeras filas, tal como se leyeron. Las columnas mapeadas están resaltadas.',
  'import.previewMore': 'y {count} filas más',
  'flag.duplicateGeometry.title': '{a} y {b} son el mismo contorno',
  'flag.duplicateGeometry.detail': 'Comparten el {percent}% del más chico ({area} ha). Eso suele ser el mismo lote cargado dos veces. La corrección automática conserva el que elija y elimina el otro.',
  'guidance.duplicate-geometry': 'Dos lotes que cubren el mismo terreno casi siempre son un lote importado dos veces — un archivo cargado de nuevo, o el mismo bloque presente en dos de ellos. Subir los dos cuenta el área por duplicado y deja dos filas disputando el mismo lugar. Quédese con el que tenga mejor nombre y mejor geometría y elimine el otro; si de verdad son dos lotes vecinos que solo se superponen, corrija la superposición.',
  'category.duplicate-geometry': 'Contorno repetido',
  'overlap.duplicateTitle': 'Conservar uno de dos contornos idénticos',
  'overlap.duplicateIntro': 'Estos dos cubren el mismo terreno. Elija cuál conservar — el otro lote y sus polígonos se eliminan. Ctrl+Z lo trae de vuelta.',
  'overlap.duplicateConfirm': 'Eliminar el otro lote',
  'overlap.duplicateLoses': '{field} se eliminará, con polígonos y todo.',
  'fix.duplicateDeleted': 'Se eliminó {field}.',
